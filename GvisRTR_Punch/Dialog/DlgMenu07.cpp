...
void CDlgMenu07::InitStatic()
{
	myStcReelmap.SubclassDlgItem(IDC_STC_REELMAP_MIDDLE, this);
	myStcReelmap.SetHwnd(this->GetSafeHwnd(), IDC_STC_REELMAP_MIDDLE);
...
void CDlgMenu07::OnShowWindow(BOOL bShow, UINT nStatus)
{
